...
public:
	...
	System::UInt32											Get_ADC(System::Boolean^ read_success);

	System::Boolean											Set_Timer1_Top(System::UInt16 top);
	System::Boolean											Set_Timer4_Prescaler(MIDI_Lighter_Wrapper::Timer4_Presacler prescaler);
