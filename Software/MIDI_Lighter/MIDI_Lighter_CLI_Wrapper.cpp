...
MIDI_Lighter_Wrapper::Configuration_MIDI^ MIDI_Lighter_Wrapper::Get_Configuration_MIDI(System::Boolean^ read_success)
{
	...
	Managed_Configuration_MIDI->Factor			= Configuration_MIDI.Factor;
...
System::Boolean MIDI_Lighter_Wrapper::Set_Configuration_MIDI(MIDI_Lighter_Wrapper::Configuration_MIDI^ midi)
{
	...
	Configuration_MIDI.Factor			= midi->Factor;
...
MIDI_Lighter_Wrapper::Configuration_RGB_Order^ MIDI_Lighter_Wrapper::Get_Configuration_RGB_Order(System::Boolean^ read_success)
{
	bool Success;

	HAL::MIDI_Lighter::Configuration_RGB_Order Configuration_RGB_Order = _MIDI_Lighter->Get_Configuration_RGB_Order(&Success);

	read_success = Success;

	MIDI_Lighter_Wrapper::Configuration_RGB_Order^ Managed_Configuration_RGB_Order = gcnew MIDI_Lighter_Wrapper::Configuration_RGB_Order();

	Managed_Configuration_RGB_Order->RGB_Order = (MIDI_Lighter_Wrapper::RGB_Order)Configuration_RGB_Order.RGB_Order;
	
	return Managed_Configuration_RGB_Order;
}

System::Boolean	MIDI_Lighter_Wrapper::Set_Configuration_RGB_Order(MIDI_Lighter_Wrapper::Configuration_RGB_Order^ rgb_order)
{
	HAL::MIDI_Lighter::Configuration_RGB_Order Configuration_RGB_Order;

	Configuration_RGB_Order.RGB_Order = (HAL::MIDI_Lighter::RGB_Order)rgb_order->RGB_Order;
